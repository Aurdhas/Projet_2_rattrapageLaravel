...
<body>
    <section class="bg-gray-50 flex flex-col items-center justify-center">
        <div
            class="w-1/2 bg-white rounded-lg shadow-lg shadow-gray-700 md:my-20 sm:max-w-md xl:p-0 bg-gradient-to-r from-red-500 to-orange-500 dark:border-gray-700">
