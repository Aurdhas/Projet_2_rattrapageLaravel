                    ...
                    <form method="POST" action="{{ route('update') }}">
                        ...
                        <div
                            ...
                            <div class="w-full  mb-4 mt-6">
                                ...
                                <input type="text"
                                    class="mt-2 p-4 w-50 border-2 rounded-lg dark:text-gray-900 dark:border-gray-600 dark:bg-gray-200"
                        ...
                        <div class=" w-full flex justify-center items-center  mb-4 lg:mt-6">
                            <button type="submit"
                                class="mt-2 p-4  w-[18rem] text-white bg-black hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Update profile</button>
                        </div>
                    </form>
                </div>
            </div>
